                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title text-center">SISTEM PENGAMBILAN KEPUTUSAN</h2>
                            <br>
                            <img class="img-fluid" src="css/logo KPU.png">
                            <br>
                        </div>
                        <div class="panel-body">
                            ...
                            <form role="form" action="" method="POST">
                                <fieldset>
                                    ...
                                    <input type="submit" name="submit" class="btn btn-lg btn-warning btn-block" value="login" >
