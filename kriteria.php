                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a onclick="return confirm('Apakah yakin menghapus ?')" href='aksi/hapusk.php?name=<?=$barisbobot['id_kriteria'];?>'>hapus</a> | <a href='aksi/editk.php?name=<?=$barisbobot['id_kriteria'];?>'>edit</a></td>
                                                </tr>
                                                <?php
                                                    $n++;
                                                    }
